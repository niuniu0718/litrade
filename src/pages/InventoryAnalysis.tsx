              ...
              <div style={{ ...glassCard, ...CARD_BODY }}>
                ...
                <div style={{ display: 'flex', gap: 16 }}>
                  <div>
                    ...
                    <div style={{ fontSize: 14, fontWeight: 600, color: dim.momChange >= 0 ? '#ef4444' : '#10b981', marginTop: 2 }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 14, fontWeight: 600, color: dim.wowChange >= 0 ? '#ef4444' : '#10b981', marginTop: 2 }}>
